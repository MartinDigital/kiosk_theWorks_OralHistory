...
direct_commands = ['kwebhelper.py','omxplayergui.py','kwebhelper_set.py','omxplayer','gksudo','xterm','/media/PiShare/Git/kiosk_OralHistory/startOMX.sh','/media/PiShare/Git/kiosk_OralHistory/startCCOMX.sh','/media/PiShare/Git/kiosk_OralHistory/stopOMX.sh','/media/PiShare/Git/kiosk_OralHistory/volumeUp.sh','/media/PiShare/Git/kiosk_OralHistory/volumeDown.sh']
